...
- Full `depose package` signed bundle production from the JSONL session transcript
...
| `produce.sh` | Executable script that runs `depose package --from-claude` on the JSONL |
