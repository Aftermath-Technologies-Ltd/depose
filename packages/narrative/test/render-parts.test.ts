// packages/narrative/test/render-parts.test.ts
//
// The pieces the two renderers are built from: the Rule 902(13)
// certificate, the per-event summary, section grouping, and the view
// model. Whole-document rendering is in render.test.ts.
